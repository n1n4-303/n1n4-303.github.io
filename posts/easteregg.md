...
<br />The effects are not the main focus here so I won't be into a lot of the details, however, I will show you how I implemented them. All the effects are subpatches, so you will see an [inlet~] and [outlet~] on them so the audio passes through.
<br />
...
<br />On my master output I send the signal to a VU meter so I can monitor my levels
